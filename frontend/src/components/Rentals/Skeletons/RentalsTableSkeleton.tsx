    ...
    <div data-testid="recent-rentals-table-skeleton" className="p-4">
      <div className="space-y-3">
        {[...Array(SKELETON_TABLE_ROW_COUNT)].map((_, i) => (
          ...
          >
            <Skeleton className="h-6 w-20 sm:1/8 mr-auto" />
            <Skeleton className="h-6 w-15 sm:w-1/12 mx-auto" />
            ...
            <Skeleton className="h-6 w-10 sm:w-1/13 ml-auto" />
          </div>
        ))}
      </div>
    </div>
...
export default RentalsTableSkeleton;
